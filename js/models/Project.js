...
export const PROJECTS = [
  ...
  new Project({
    ...
    icon: 'waves',
    tags: ['JavaScript', 'HTML', 'CSS', 'GSAP', 'Chart.js', 'UI Overhaul', 'Web'],
  }),
  new Project({
  ...
  new Project({
    title: 'Pixel Paint',
    description: 'A paint by pixel game in the browser. Bring your own image to paint.',
    longDescription:
  ...
  new Project({
    title: 'NEO ICON',
    description:
      'A tool for generating icons from text, converting and resizing existing images.',
    longDescription:
  ...
  new Project({
    title: 'NEO Compare',
    description: 'A fast, browser-based tool for comparing two pieces of text side by side.',
    longDescription:
